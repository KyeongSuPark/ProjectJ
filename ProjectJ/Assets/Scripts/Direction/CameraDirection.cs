...
public class CameraDirection : MonoBehaviour
{
    ...
    {
        CameraDirection camDirector = Camera.main.GetComponent<CameraDirection>();
        camDirector.MoveToPath(R.String.COLOR_MODE_PATH);
    }

    public static void MoveToNoramlMode()
    {
        CameraDirection camDirector = Camera.main.GetComponent<CameraDirection>();
        camDirector.MoveToPath(R.String.NORMAL_MODE_PATH);
    }
}
